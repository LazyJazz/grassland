...
//  glfwGetKeyName(). (#5908) 2022-10-18: Perform a dummy glfwGetError() read to
//  cancel missing mouse cursors errors. Using GLFW_VERSION_COMBINED directly.
//  (#5785) 2022-10-11: Using 'nullptr' instead of 'NULL' as per our switch to
//  C++11. 2022-09-26: Inputs: Renamed ImGuiKey_ModXXX introduced in 1.87 to
//  ImGuiMod_XXX (old names still supported). 2022-09-01: Inputs: Honor
//  GLFW_CURSOR_DISABLED by not setting mouse position. 2022-04-30: Inputs:
