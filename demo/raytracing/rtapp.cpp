...
void RayTracingApp::OnInit() {
  ...
  top_level_acceleration_structure_ = std::make_unique<
      ...
      std::vector<std::pair<grassland::vulkan_legacy::raytracing::
  ...
  ray_tracing_render_node_ = std::make_unique<
      grassland::vulkan_legacy::framework::RayTracingRenderNode>(core_.get());
